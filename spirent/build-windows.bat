...
cmake . -A x64 -DCMAKE_BUILD_TYPE=Release -DENABLE_STATIC_LIB:BOOL="1" -DENABLE_ASIO_LIB:BOOL="1" -DCMAKE_CXX_FLAGS="/EHsc" -DZLIB_LIBRARY=%ZLIB_WIN64_RELEASE% -DZLIB_INCLUDE_DIR=%STC_ROOT%\common\lib\zlib123 -DOPENSSL_ROOT_DIR=%OPENSSL_WIN64%\out32 -DOPENSSL_INCLUDE_DIR=%OPENSSL_WIN64%\inc32
...
cmake . -A x64 -DCMAKE_BUILD_TYPE=Debug -DENABLE_STATIC_LIB:BOOL="1" -DENABLE_ASIO_LIB:BOOL="1" -DCMAKE_CXX_FLAGS="/EHsc" -DZLIB_LIBRARY=%ZLIB_WIN64_DEBUG% -DZLIB_INCLUDE_DIR=%STC_ROOT%\common\lib\zlib123 -DOPENSSL_ROOT_DIR=%OPENSSL_WIN64%\out32 -DOPENSSL_INCLUDE_DIR=%OPENSSL_WIN64%\inc32
